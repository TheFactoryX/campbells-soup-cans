"""
Campbell's Soup Can #605
Produced: 2025-11-29 17:30:09
...
def main():
    ...
    print("\033[35m" + "\n\nWoody Allen (probably) said:\n" + "\033[0m") # Magenta
    print_slowly(quote, color="36")  # Cyan

    # Add a little self-deprecating flourish
    print("\033[31m" + "\n(Don't quote me on that. I'm usually wrong.)" + "\033[0m") # Red
