"""
Campbell's Soup Can #1795
Produced: 2026-01-23 13:10:17
...
def main():
    ...
    # Draw a box
    draw_box(60, 10, "33")  # Yellow box

    # Print the quote with typewriter effect
    time.sleep(1)
    typewriter_effect("  Woody Allen once said:", "33", 0.03)
    time.sleep(0.5)
    typewriter_effect(f"  \"{quote}\"", "36", 0.05)  # Cyan text
    ...
    time.sleep(1)
    typewriter_effect("  (Philosophy: because misery loves company)", "31", 0.03)  # Red text
